...
cardapio.templates = {
    ...
    item: `
        <div class="col-12 col-lg-3 col-md-3 col-sm-6 mb-5 animated fadeInUp delay-03s">
    ...
    itemCarrinho: `
        <div class="col-12 item-carrinho">
            ...
            <div class="add-carrinho">
                    ...
                    <span class="btn btn-remove no-mobile" onclick="cardapio.methodos.removerItemCarrinho('\${id}')"><i class="fas fa-times"></i></span>
            </div>
        </div>
    `,
